...
def extract_partner_name_bri(description: str):
    ...
    cleaned_up = re.sub(r'\b[A-Z]{2,}\d+[A-Z]*\b', ' ', cleaned_up)
    cleaned_up = re.sub(r'\b\d{5,}\b', ' ', cleaned_up)
...
def lambda_handler(event, context):
    ...
    Returns:
    {
        ...
        "body": {
            ...
            "fileName": "BRI_Statement_Analysis_...",
            "metadata": {
                "accountName": "...",
                "accountNumber": "...",
    ...
    try:
        ...
        detected_format = get_cell(personal_df, "Detected Format", "UNKNOWN")
        ...
        metadata = {
            ...
            'startPeriod': get_cell(personal_df, "Start Period", ""),
            'endPeriod': get_cell(personal_df, "End Period", ""),
